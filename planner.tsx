...
export default function PlannerScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* View đệm chống bị tai thỏ che khuất Header */}
          ...
          <View style={styles.timelineItem}>
            ...
            <View style={styles.activityCard}>
              ...
              <View style={styles.activityBody}>
                ...
                <Text style={styles.activityDesc}>Depart from Marina Grande. Visit the Blue Grotto and Faraglioni rocks.</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.notesCard}>
            ...
            <View style={styles.notesBox}>
                <Text style={styles.notesText}>
                    "Remember to bring extra cash for the Blue Grotto entrance fee (15€)."
                </Text>
            </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  // Miếng đệm chống tràn cho thanh trạng thái
  statusBarPad: { 
