...
// Lấy chiều cao StatusBar, nếu Android bị null thì mặc định khoảng 30-40
...
export default function TripsScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* Để StatusBar trong suốt và chữ đen */}
...
const styles = StyleSheet.create({
  container: { 
    ...
    // Tăng paddingTop để đẩy toàn bộ nội dung xuống dưới Status Bar
  ...
  tabSelector: { flexDirection: 'row', backgroundColor: '#F3F4F6', borderRadius: 14, padding: 4, marginTop: 10, marginBottom: 20 },
